...
export default class GraphComponent extends Component {
  ...
  insertDiagram() {
   ...
   const myDiagram =
    ...
    const nodeDataArray = [];
    let graphdatas = this.store.peekAll('graphdata');
    graphdatas.forEach(function(graphData) {
      let data = { key: graphData.id, text: graphData.text, color: graphData.color, group: graphData.group };
      if (graphData.id === '5') {
        data = {key: graphData.id, text: graphData.text, color: graphData.color, isGroup: true};
      }
